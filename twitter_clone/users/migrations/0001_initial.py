...
import twitter_clone.users.models
import twitter_clone.users.validators
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', twitter_clone.users.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('bio', models.TextField(blank=True, max_length=2048, null=True, verbose_name='Biography')),
